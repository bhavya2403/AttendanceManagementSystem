            ...
            <div className="card" style={{backgroundColor: 'white',width: '1160px',height: '720px', marginTop: '20px', borderRadius: '14px', boxShadow:'0px 10px 30px hsl(185, 75%, 35%)'}}>
                 <div className="card-body" > {/*used for padding content inside the card element */}
                    ...
                    <div className="progress mb-4" style={{height: '15px'}}>
                        <div className="progress-bar  custom-progress-bar1" height="20px" role="progressbar" style={{width: '80%'}} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
                    ...
                    <div className="progress mb-4" style={{height: '15px'}}>
                        <div className="progress-bar custom-progress-bar2" label="72% completed"  role="progressbar" style={{width: '72%'}} aria-valuenow="72" aria-valuemin="0" aria-valuemax="100">
                            <span style={{textAlign: 'right'}}>72%</span>
                        </div>
                    </div>
                    <h2>Introduction to Robotics</h2>
                    <div className="progress mb-4" style={{height: '15px'}}>
                        <div className="progress-bar custom-progress-bar3" role="progressbar" style={{width: '89%'}} aria-valuenow="89" aria-valuemin="0" aria-valuemax="100">
                            <span style={{textAlign: 'right'}}>89%</span>
                        </div>
                    </div>
                    <h2>Distributed Systems</h2>
                    <div className="progress mb-4" style={{height: '15px'}}>
                        <div className="progress-bar custom-progress-bar4" role="progressbar" style={{width: '55%'}} aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">
                            <span style={{textAlign: 'right'}}>55%</span>
                        </div>
                    </div>
                    <h2>Introduction to Cryptography</h2>
                    <div className="progress mb-4" style={{height: '15px'}}>
                        <div className="progress-bar custom-progress-bar5" role="progressbar" style={{width: '66%'}} aria-valuenow="66" aria-valuemin="0" aria-valuemax="100">
                            <span style={{textAlign: 'right'}}>66%</span>
                        </div>
                    </div>
                    <h2>Indian Cinema</h2>
                    <div className="progress mb-4" style={{height: '15px'}}>
                        <div className="progress-bar custom-progress-bar6" role="progressbar" style={{width: '45%'}} aria-valuenow="45" aria-valuemin="0" aria-valuemax="100">
