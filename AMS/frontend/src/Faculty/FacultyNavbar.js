...
function FacultyNavbar(){
    return (   
      ...
      <div className="container-fluid" >
         <Link className="navbar-brand" to="/faculty/" style={{color: 'white'}}>Profile</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <Link className="nav-link active" to="/faculty/view_courses" style={{color: 'white'}} >View Courses</Link>
