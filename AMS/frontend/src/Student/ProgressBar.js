...
function ProgessBar(props) {
    ...
    return (
        ...
        <div className="card" style={{ backgroundColor: '#EDF1D6', width: '990px', height: '650px', marginTop: '80px', borderRadius: '14px', boxShadow: '0px 10px 30px black' }}>
            <div className="card-body" > {/*used for padding content inside the card element */}
                ...
                <div className="progress mb-4">                                                   
                    ...
                    <span style={{ textAlign: 'right' }}>{`${(props.sData.courses[0][1]/parseFloat(props.sData.courses[0][2])*100).toFixed(1)}%`}</span>
                ...
                <div className="progress mb-4">
                    ...
                    <span style={{ textAlign: 'right' }}>{`${(props.sData.courses[1][1]/parseFloat(props.sData.courses[1][2])*100).toFixed(1)}%`}</span>
                ...
                <div className="progress mb-4">
                    ...
                    <span style={{ textAlign: 'right' }}>{`${(props.sData.courses[2][1]/parseFloat(props.sData.courses[2][2])*100).toFixed(1)}%`}</span>
                ...
                <div className="progress mb-4">
                    ...
                    <span style={{ textAlign: 'right' }}>{`${(props.sData.courses[3][1]/parseFloat(props.sData.courses[3][2])*100).toFixed(1)}%`}</span>
                ...
                <div className="progress mb-4">
                    ...
                    <span style={{ textAlign: 'right' }}>{`${(props.sData.courses[4][1]/parseFloat(props.sData.courses[4][2])*100).toFixed(1)}%`}</span>
                ...
                <div className="progress mb-4">
                    ...
                    <span style={{ textAlign: 'right' }}>{`${(props.sData.courses[5][1]/parseFloat(props.sData.courses[5][2])*100).toFixed(1)}%`}</span>
