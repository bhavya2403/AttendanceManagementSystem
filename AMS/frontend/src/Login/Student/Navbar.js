...
function Navbar(){
    return (   
          ...
          <div className="container-fluid" >
             <Link className="navbar-brand" to="/Student/Profile" style={{color: 'white'}}>Profile</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <Link className="nav-link active" to="/Student/SeeCourses" style={{color: 'white'}}>See all courses</Link>
